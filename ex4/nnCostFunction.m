...
theta1 = sum(sum(theta1_withoutbias .^ 2));
theta2 = sum(sum(theta2_withoutbias .^ 2));
...
Theta1ZeroedBias = [ zeros(size(Theta1, 1), 1) theta1_withoutbias ];
Theta2ZeroedBias = [ zeros(size(Theta2, 1), 1) theta2_withoutbias ];
